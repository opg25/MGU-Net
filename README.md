This is a modified version of Jiaxuan Li's MGU Net, which itself is built on [AI-Challenger-Retinal-Edema-Segmentation](https://github.com/ShawnBIT/AI-Challenger-Retinal-Edema-Segmentation) and [GloRe](https://github.com/facebookresearch/GloRe). It was modified to be directly and easily implementable as one small part of the Biomarker Segmentation project in collaboration with University of Bath and Siloton. That project is private so not visible on my GitHub profile.
